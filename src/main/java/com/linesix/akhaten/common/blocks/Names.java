...
public class Names {
    ...
    public class Machines {
        ...
        public class Tardis {
            ...
            public static final String monitor = "tardis_monitor";
            public static final String tardis_core = "tardis_core";
            public static final String tardis_corebeam = "tardis_corebeam";
            public static final String tardis_coreframe = "tardis_coreframe";
            public static final String tardis_coreconnector = "tardis_coreconnector";
            public static final String tardis_consoleinterface = "tardis_consoleinterface";

            public class Hartnell {
            ...
            public class Coral {
                ...
                public static final String coral_consoleblock = "block_coralconsole_block";
                
                public static final String coral_roundel_a = "block_coralroundel_a";
                public static final String coral_roundel_b = "block_coralroundel_b";
                public static final String coral_roundel_c = "block_coralroundel_c";
            }   
        }
